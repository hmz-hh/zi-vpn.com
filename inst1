...
read -p "Enter the number of days for the certificate: " days
openssl req -new -newkey rsa:4096 -days $days -nodes -x509 -subj "/C=US/ST=California/L=Los Angeles/O=Example Corp/OU=IT Department/CN=zivpn" -keyout "/etc/zivpn/zivpn.key" -out "/etc/zivpn/zivpn.crt"
