...
# File to track installation status
INSTALL_FILE="$HOME/.zivpn_installed"

if [ ! -f "$INSTALL_FILE" ]; then
    echo -e "First time running the script, downloading required files..."
...
# Continue with the password prompt
...
# Start and enable ZIVPN service
